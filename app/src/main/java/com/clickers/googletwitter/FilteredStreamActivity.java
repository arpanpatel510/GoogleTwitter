...
public class FilteredStreamActivity extends AppCompatActivity {
    MainActivityViewModel mainActivityViewModel;
    Handler handler;
    TextView textView;
    int placeCounter;
    int totalCounter;
    int tweetPlacesCounter;
    int errorCounter;
    ProgressDialog dialog;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_filtered_stream);
        mainActivityViewModel =  new ViewModelProvider(this).get(MainActivityViewModel.class);
         dialog = ProgressDialog.show(FilteredStreamActivity.this, "",
